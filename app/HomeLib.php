            ...
            case 0: //buy
                switch ($typology) {
                    ...
                    case 1: //house, country house or apartment
                        ...
                        break;
                    case 4: //office
                        $list = \DB::table('sell_office')
                            ->select('admin_area_lvl2')
                            ->groupBy('admin_area_lvl2')
                            ->orderBy('admin_area_lvl2', 'ASC')
                            ->get();
                        break;
                    case 5: //business
                        $list = \DB::table('sell_business')
                            ->select('admin_area_lvl2')
                            ->groupBy('admin_area_lvl2')
                            ->orderBy('admin_area_lvl2', 'ASC')
                            ->get();
