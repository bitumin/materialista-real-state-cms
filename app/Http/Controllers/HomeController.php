...
class HomeController extends Controller {
    ...
    public function index()
    {
        ...
        return view('home_search', compact('options'));
    }
    ...
    public function getResults()
    {
        ...
        return view('results',compact('ads','typology','locality','search_type','input','options'));
    }
        ...
        if($validator->passes()) {
            \Mail::queue('ad_contact', $input, function($message) use ($input) {
                ...
                $message->from($options->company_email,$options->company_name)
                    ->replyTo($input['contactEmail'], $input['contactName'])
